...
rTimesLocR4P = vec(readdlm("bTimes/tolRuntimR4P.txt"))
rTimesLocR5P = vec(readdlm("bTimes/tolRuntimR5P.txt"))
...
rTimesLocROCK2 = vec(readdlm("bTimes/rTimesLocROCK2.txt"))
...
ax3 = Axis(fig1[2,1], xscale = log10, yscale = log10, xlabel ="reltol", ylabel="Runtime [s]", title = "Runtime implicit ", xreversed = true)
ax4 = Axis(fig1[2,2], xscale = log10, yscale = log10, xlabel ="reltol", ylabel="Runtime [s]", title = "Runtime explicit ", xreversed  = true)
