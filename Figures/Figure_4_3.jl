...
ax1 = Axis(fig1[1,1], xscale = log10, yscale = log10,xlabel ="reltol", ylabel="Timestep at localization [s]", title = "Localization Δt implicit ", xreversed = false)
ax2 = Axis(fig1[1,2], xscale = log10, yscale = log10,xlabel ="reltol", ylabel="Timestep at localization [s]", title = "Localization Δt explicit ", xreversed  =false)
...
axislegend(ax2, merge = false, unique = false, position = :lt)

ax3 = Axis(fig1[2,1], xscale = log10, yscale = log10,xlabel ="reltol", ylabel="Runtime [s]", title = "Runtime implicit ", xreversed = false)
ax4 = Axis(fig1[2,2], xscale = log10, yscale =log10,xlabel ="reltol", ylabel="Runtime [s]", title = "Runtime explicit ", xreversed  = false)
