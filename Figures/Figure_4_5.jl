...
ax1 = Axis(fig1[1,1], xlabel="Time [kyr]",ylabel = "Error τ [Pa]",xscale = log10, yscale=log10)
empty!(ax1)
lines!(reltol, maxErr1, linewidth = 3, label ="Rodas4P" )
lines!(reltol, maxErr2, linewidth = 3, label ="Rodas5P")
lines!(reltol, maxErr3, linewidth = 3, label ="ROCK2", color =:purple )
